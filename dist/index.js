...
let packs1 = [
    {
        pack: "query,dsc․gg ̸fijifut,,95,100,-1,-1,-1,false,100",
        amount: 1
    },
    {
        pack: "query,dsc․gg ̸fijifut,,90,100,-1,-1,-1,false,100",
        amount: 1
    },   // "query,madfut_icon,,64,100,-1,-1,-1,false,100"
    {
        pack: "query,dsc․gg ̸fijifut,,64,100,-1,-1,-1,false,100",
        amount: 1
    }, 
];
...
console.log("Disabling Trading Commands...");
...
bot.on("link", async (interaction, username)=>{
    await interaction.createMessage(`Auto Linking \`${username}\`...`);
    ...
    try {
        ...
        try {
            ...
            interaction.createFollowup(`Your MADFUT account \`${username}\` has been Linked!. U can now use commands like /mf wallet!`); }
        ...
        embeds: [
            {
                color: 191970,
                author: {
                    name: `${interaction.member.username}'s Wallet (Page ${page}/${numPages})`,
                    icon_url: "https://cdn.discordapp.com/avatars/829613363851558932/6d81ac8b4fced6f1ce43cd7f159a55ee.png?size=1024"
                },
                description: "Bot Created by <@806139789114998824> | v.1.0.2",
                fields: walletFields
            }
        ]
    });
...
console.log("The FIJIFUT BOT Is Working Now");